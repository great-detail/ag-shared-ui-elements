...
namespace AwesomeGolf.UI
{
    ...
    public partial class GDInputField : VisualElement
    {
        ...
        {
            if (RemoveUnwantedCharacters(Text, out var modified))
                Text = modified;
        ...
        public static bool RemoveUnwantedCharacters(string original, out string modified)
        {
            ...
            modified = original.TrimStart(' ').Replace("  ", " ");
            modified = Regex.Replace(modified, EmojiPattern, "");
